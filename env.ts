...
const BUNDLE_IDS = {
  development: 'com.skillbridge.development',
  preview: 'com.skillbridge.preview',
  production: 'com.skillbridge',
} as const;
...
const SCHEMES = {
  development: 'SkillBridge',
  preview: 'SkillBridge.preview',
  production: 'SkillBridge',
} as const;

const NAME = 'SkillBridge';
